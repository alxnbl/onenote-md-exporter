...
namespace alxnbl.OneNoteMdExporter.Infrastructure
{
    public class AppSettings
    {
        ...
        /// <summary>
        /// PanDoc --columns https://pandoc.org/MANUAL.html#general-options
        /// </summary>
        public static string PanDocColumns { get; set; } = "72";

        /// <summary>
        /// PanDoc --lua-filter https://pandoc.org/MANUAL.html#general-options
        /// </summary>
        public static string PanDocLuaFilter { get; set; } = "";
